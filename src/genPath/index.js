...
var genPath = function (page_directory) {
  var pathMaker = function () {
    ...
    var readFileProperties = function (filepath) {
      ...
      if (
        component === null || component === void 0 ? void 0 : component.length
      ) {
        result.component = component[0].split("default")[1].trim();
      }
      if (props === null || props === void 0 ? void 0 : props.length) {
        var name_1 = props.filter(function (match) {
          return match.includes("name");
        });
        var icon = props.filter(function (match) {
          return match.includes("icon");
        });
        var index = props.filter(function (match) {
          return match.includes("index");
        });
        if (name_1.length) result.name = name_1[0].split(":")[1].trim();
    ...
    var makePathsArray = function (paths, prevPath) {
      ...
      for (var _i = 0, _a = Object.entries(paths); _i < _a.length; _i++) {
        ...
        if (typeof path === "string") {
          ...
          result.push(oj);
        } else result.push.apply(result, makePathsArray(path, true));
      }
      return result;
    };
